...
def parse_args():
    ...
    parser.add_argument("--rag", type=str, default='/data/engine/yjchai/models/clip-vit-large-patch14', help="rag model path")
...
class ProcessorGradientFlow():
    ...
    def preprocess_img(self, images):
        # print("preprocess images", images.shape)
        images = self.resize(images)
        # print("resize images", images.shape)
...
class WrapAdvModel(torch.nn.Module):
    ...
    def forward(self, 
        ...
        image = self.image
        # print(f'original img size:{image.shape}')
        ...
        # print(f'after jpeg compression img size:{image.shape}')
        ...
        # print('before preprocess image:',image.shape)
...
def main():
    ...
    # load image
    image_path = "/data/engine/yjchai/Agent-Smith-main/attack/demo.png"
    ...
    # load target
    target_path = "/data/engine/yjchai/Agent-Smith-main/attack/demo.txt"
