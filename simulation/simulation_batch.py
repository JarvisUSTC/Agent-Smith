...
def parse_args():
    ...
    parser.add_argument("--vlm", type=str, default="/data/engine/yjchai/models/llava-1.5-7b-hf", help="vlm model path")
    parser.add_argument("--clip", type=str, default="/data/engine/yjchai/models/clip-vit-large-patch14", help="vlm model path")
